...
final class TransactionalCampaignsTests extends TestCase
{
    ...
    public const SEND_RECIPIENT = '';
    public const SEND_RECIPIENT_FIRST_NAME = '';
    public const SEND_RECIPIENT_LAST_NAME = '';
    public const SEND_SENDER_NAME = 'unitTest Sender';
    public const SEND_SENDER_EMAIL = 'info@maropost.com';
    public const SEND_SENDER_REPLYTO = 'noreply@maropost.com';
    public const SEND_CONTENT_ID = 162;

    public const SEND_CAMPAIGN_ID = 0;
